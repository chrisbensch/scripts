...
ln -s /opt/metasploit/msfdb /usr/bin/msfdb
chmod 750 /opt/metasploit/msfdb
msfdb reinit

#--- First time run with Metasploit
(( STAGE++ )); echo -e " ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) ${GREEN}Starting Metasploit for the first time${RESET} ~ this ${BOLD}will take a 50 seconds${RESET} (~6 mintues)"
