...
<channel name="xfce4-panel" version="1.0">
  ...
  <property name="plugins" type="empty">
    ...
    <property name="plugin-4" type="string" value="directorymenu">
      ...
      <property name="base-directory" type="string" value="/home/analyst"/>
    </property>
    <property name="plugin-6" type="string" value="launcher">
      <property name="items" type="array">
        <value type="string" value="16764949742.desktop"/>
      </property>
    </property>
    <property name="plugin-7" type="string" value="launcher">
      <property name="items" type="array">
        <value type="string" value="16764949743.desktop"/>
        <value type="string" value="16764949744.desktop"/>
        <value type="string" value="16764949745.desktop"/>
      </property>
    ...
    <property name="plugin-23" type="string" value="launcher">
      <property name="items" type="array">
        <value type="string" value="16766676551.desktop"/>
      </property>
    </property>
  </property>
</channel>
